...
export default function Modal({ isOpen, onClose, title, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0a0523]/80 backdrop-blur-sm">
      <div className="w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col rounded-2xl border border-indigo-500/30 bg-indigo-950/40 backdrop-blur-md shadow-[0_0_40px_rgba(139,92,246,0.15)] relative m-4">
